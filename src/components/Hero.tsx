...
const slides = [
  { image: aImage, alt: "Nature camping experience" },
  { image: bImage, alt: "Forest camping spot" },
  { image: cImage, alt: "Lakeside retreat" },
  { image: dImage, alt: "Mountain view" },
];
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-20 left-6 md:left-12 lg:left-16 z-10 text-white">
        ...
        >
          <span className="text-orange-400">Lepaskan</span>
          <span className="text-orange-400">untuk Terhubung Kembali</span>
        </motion.h1>
